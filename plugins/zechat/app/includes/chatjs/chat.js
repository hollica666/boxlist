    ...
    if(event.keyCode == 13 && event.shiftKey == 0)  {
        ...
        if (message != '') {
            $.post(siteurl+plugin_directory+"?action=sendchat", {to: chatboxtitle, message: message} , function(data){
                ...
                msg_oddtpl(chatboxtitle,session_uname,session_img,message,"Just Now","append","fa-clock-o");
            ...
            plupload.each(arg, function(value, key) {
                if (typeof(value) != "function") {
                    if(key == "response"){
                        ...
                        msg_oddtpl(toName,session_uname,session_img,message_content,"Just Now","append","fa-check");
