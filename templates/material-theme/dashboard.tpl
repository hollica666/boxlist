                    ...
                    <form id="uploadForm" method="post" action="#" enctype="multipart/form-data">
                        <section>
                            <div class="user-details box">
                                <div class="user-image">
                                    <div class="image">
                                        ...
                                        <div class="single-file-input">
                                            ...
                                            <div>{LANG_UPLOAD-PICTURE} <i class="fa fa-upload"></i></div>
                                        </div>
                                    </div>
                                    <!--end image-->
                                </div>
                                ...
                                <div class="description clearfix">
                                    <h3>&nbsp;</h3>
                                    <h2>{AUTHORNAME}</h2>
                                    <a href="{LINK_ACCOUNT_SETTING}" class="btn btn-default btn-rounded scroll btn-xs">{LANG_ACCOUNT-SETTING}</a>
                                    <hr>
                                    <figure>
                                        <div class="pull-left"><strong>{LANG_JOIN-DATE} :</strong></div>
                        ...
                        <section>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="input-field">
                                        <label for="heading">{LANG_PROFILE-TAGLINE}</label>
