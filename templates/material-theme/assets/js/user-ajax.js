    ...
    $('#js-table-list').on('click', '.item-js-hide', function (e) {
        ...
        $.post(ajaxurl + '?action=' + action, data, function (response) {
            if (response == 1) {
                ...
                alert("Problem in Ad Hide/Show, Please try again.");
            }
        });
    });
            ...
            success: function(result){
                if (result == 1) {
                    if(action == 'removeFavAd'){
                        ...
                        $('.fav_'+adId).attr('data-original-title','Remove Favourite');
                        $('.tooltip').remove();
                    }
                    ...
                    $('.fav_'+adId).attr('data-original-title','Add Favourite');
                    $('.tooltip').remove();
                }
                else{
                    alert("Something Wrong to add fav.");
                }
            }
        });
    });
