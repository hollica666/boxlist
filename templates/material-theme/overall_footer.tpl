            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="footer-widget widget-news" style="height: 240px;">
                        <div class="widget-top">
                            <h3 class="widget-title">{LANG_LATEST-ADS}</h3>
                        </div>
                        <div class="widget-body">
                            {LOOP: ITEM}
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <a href="{ITEM.link}" class="read">{LANG_READ-MORE} <i class="fa fa-caret-right"></i></a>
                                </div>
                            </div>
                            {/LOOP: ITEM}
