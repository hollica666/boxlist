...
<div id="page-content">
    <div class="container">
        <ul class="breadcrumb bcstyle2">
            ...
            <li class="active"><a>{LANG_RESUBMITED-ADS}</a></li>
        </ul>
        <a href="{LINK_POST-AD}" class="postadinner"><span> <i class="fa fa-plus-circle"></i> {LANG_POST-AD}</span></a>
        <!--end breadcrumb-->
        <section class="page-title center"><h1>{LANG_RESUBMITED-ADS}</h1></section>
        <!--end page-title-->
        <section>
            <div class="row mt40">
                                ...
                                <div class="collapse-box"><h5 class="collapse-title"> {LANG_MY-ADS} <a class="pull-right" data-toggle="collapse" href="#MyAds"><i class="fa fa-angle-down"></i></a></h5>
                                    ...
                                    <div id="MyAds" class="panel-collapse collapse in">
                                        <ul class="acc-list">
                                            ...
                                            <li class="active"><a href="{LINK_RESUBMITADS}" class="waves-effect"><i class="fa fa-flag"></i> {LANG_RESUBMITED-ADS} <span class="badge">{RESUBMITADS}</span></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="collapse-box">
                ...
                <div class="col-sm-9 page-content">
                    <div class="inner-box"><h1>{LANG_RESUBMITED-ADS} </h1>
