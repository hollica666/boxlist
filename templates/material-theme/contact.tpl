    ...
    <div id="page-content">
        <div class="container">
            ...
            <section class="page-title">
                <h1 class="pull-left">{LANG_CONTACT-US}</h1>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-3">
                        <h3>{LANG_CONTACT-INFORMATION}</h3>
                        <div class="box">
                            <address>
                    ...
                    <div class="col-md-9 col-sm-9">
                        ...
                        <form method="post">
                            <div class="row">
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <button type="submit" name="Submit" class="btn btn-primary icon shadow">{LANG_SEND-MESSAGE}<i class="fa fa-caret-right"></i></button>
                                </div>
                            </div>
                            <!--end row-->
