        ...
        <div class="container">
            <div class="header-left">
                ...
                <nav class="navi main-nav">
                    <ul>
                        <li><a href="{LINK_INDEX}">{LANG_HOME}</a>
                            <ul class="sub-menu">
                                <li> <a class="" href="{LINK_INDEX1}">{LANG_HOME-IMAGE} </a> </li>
                                <li> <a class="" href="{LINK_INDEX2}">{LANG_HOME-MAP} </a> </li>
                            </ul>
                        </li>
            ...
            <div class="header-right">
                IF("{LOGGED_IN}"=="0"){
                <div class="user">
                    <a href="#" data-toggle="modal" data-target="#loginPopUp" class="waves-effect pad-lr-10 modal-trigger">{LANG_SIGN-IN}</a>
                    <a href="{LINK_SIGNUP}" class="waves-effect pad-lr-10">{LANG_REGISTER}</a>
                    <a href="{LINK_POST-AD}" class="btn btn-rounded btn-default waves-effect">{LANG_POST-FREE-AD}</a>
                </div>
                {:IF}
                ...
                <ul class="account-action">
                    ...
                    <li class="">
                        ...
                        <div class="account-dropdown">
                            <ul>
                                <li><a href="{LINK_DASHBOARD}" class="waves-effect"> <i class="fa fa-file"></i>{LANG_MY-CLASSIFIED}</a></li>
                                <li><a href="{LINK_PROFILE}/{USERNAME}" class="waves-effect"> <i class="fa fa-user"></i>{LANG_PROFILE-PUBLIC}</a></li>
                                <li><a href="{LINK_POST-AD}" class="waves-effect"> <i class="fa fa-plus-circle"></i>{LANG_POST-FREE-AD}</a></li>
                                <li><a href="{LINK_MYADS}" class="waves-effect"> <i class="fa fa-building"></i>{LANG_MY-ADS-LISTINGS}</a></li>
                                <li><a href="{LINK_FAVADS}" class="waves-effect"> <i class="fa fa-heart"></i>{LANG_FAVOURITE-ADS}</a></li>
                                <li><a href="{LINK_PENDINGADS}" class="waves-effect"> <i class="fa fa-clock-o"></i>{LANG_MY-PENDING-ADS}</a></li>
