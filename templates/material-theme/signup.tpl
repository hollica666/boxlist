                    ...
                    <div id="post-form" style="padding:10px">
                        <form method="post" action="#" accept-charset="UTF-8">
                            <div class="input-field">
                                <label for="name">{LANG_FIRST-NAME}</label>
                            ...
                            <div class="input-field center">
                                <button type="submit" name="submit" id="submit" class="btn btn-primary waves-effect">{LANG_REGISTER-NOW}</button>
                            </div>
                            <!--end input-field-->
                            <hr>

                            <p class="center">{LANG_BY-CLICK-REGISTER} <a href="{LINK_HTML}/terms">{LANG_TERM-CON}</a></p>
