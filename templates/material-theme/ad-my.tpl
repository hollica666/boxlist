...
<div id="page-content">
    <div class="container">
        <ul class="breadcrumb bcstyle2">
            ...
            <li class="active"><a>{LANG_MY-ADS}</a></li>
        </ul>
        <a href="{LINK_POST-AD}" class="postadinner"><span> <i class="fa fa-plus-circle"></i> {LANG_POST-AD}</span></a>
        <!--end breadcrumb-->
        <section class="page-title center"><h1>{LANG_MY-ADS-LISTINGS}</h1></section>
        <!--end page-title-->
        <section>
            <div class="row mt40">
                                ...
                                <div class="collapse-box">
                                    ...
                                    <div id="account" class="panel-collapse collapse in">
                                        <ul class="acc-list">
                                            ...
                                            <li><a href="{LINK_ACCOUNT_SETTING}" class="waves-effect"><i class="fa fa-cog"></i> {LANG_ACCOUNT-SETTING} </a></li>
                ...
                <div class="col-sm-9 page-content">
                    <div class="inner-box"><h1>{LANG_MY-ADS} </h1>
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="js-table-list" class="table table-striped table-bordered add-manage-table table demo footable-loaded footable" data-filter="#filter" data-filter-text-only="true">
                                ...
                                <tr>
                                    <th> {LANG_PHOTO}</th>
                                    <th data-sort-ignore="true"> {LANG_ADS-DETAILS}</th>
                                    <th> {LANG_STATUS}</th>
                                ...
                                <tbody>
                                    ...
                                    <tr class='ajax-item-listing IF("{ITEM.status}"=="hide"){ opapcityLight {:IF}' data-item-id="{ITEM.id}" data-search-term="{ITEM.product_name}"  >
                                        ...
                                        <td class="price-td width-16-per">
                                            <div>
                                                IF("{ITEM.status}"=="hide"){ <span class="label label-info">{ITEM.status}</span>{:IF}
                                        ...
                                        <td class="action-td width-10-per">
                                            <div>
                                                ...
                                                <p class='opacity1 IF("{ITEM.status}"=="pending"){ hidden {:IF}'><a class="btn btn-warning btn-rounded btn-xs item-js-hide" href="#" data-ajax-action="hideItem">
                                                        IF("{ITEM.status}"!="hide"){ <i class="fa  fa-eye-slash"></i> {LANG_HIDE}{:IF}
                                                        IF("{ITEM.status}"=="hide"){ <i class="fa  fa-eye"></i> {LANG_SHOW}{:IF}
                                                    </a>
                                                </p>
                                                <p class="opacity1">
                                    ...
                                    <tr id="norecord" IF("{TOTALITEM}"!="0"){ style="display: none;" {:IF}>
                                        <td colspan="5">{LANG_NO-RESULT-FOUND}</td>
                                    </tr>
                                </tbody>
                            </table>
                            <!-- Pagination -->
