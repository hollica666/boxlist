    ...
    <div class="container">
        ...
        <div class="breadcrumb-section">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">{LANG_FAVOURITE-ADS}</li>
                <div class="pull-right back-result">
                    <a href="{LINK_LISTING}">
                        <i class="fa fa-angle-double-left"></i> {LANG_BACK-RESULT}
                    </a>
                </div>
            </ol>
            <!-- breadcrumb -->
                ...
                <aside class="col-sm-3 page-sidebar">
                    <div class="section">
                        <div class="user-panel-sidebar">
                            ...
                            <div class="collapse-box"><h5 class="collapse-title"> {LANG_MY-ADS} <a class="pull-right"
                                                                                                   data-toggle="collapse"
                                                                                                   href="#MyAds"><i
                                    class="fa fa-angle-down"></i></a></h5>
                                ...
                                <div id="MyAds" class="panel-collapse collapse in">
                                    <ul class="acc-list">
                                        ...
                                        <li class="active"><a href="{LINK_FAVADS}" class="waves-effect"><i
                                                class="fa fa-heart"></i> {LANG_FAVOURITE-ADS}<span class="badge">{FAVORITEADS}</span>
                                        </a></li>
