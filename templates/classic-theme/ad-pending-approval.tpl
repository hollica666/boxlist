    ...
    <div class="container">
        <div class="breadcrumb-section"><!-- breadcrumb -->
            <ol class="breadcrumb">
                ...
                <li class="active">{LANG_PENDING-ADS}</li>
                            ...
                            <div class="collapse-box">
                                ...
                                <div id="MyAds" class="panel-collapse collapse in">
                                    <ul class="acc-list">
                                        ...
                                        <li class="active"><a href="{LINK_PENDINGADS}" class="waves-effect"><i
                                        ...
                                        <li><a href="{LINK_HIDDENADS}" class="waves-effect"><i
                                                class="fa fa-eye-slash"></i> {LANG_HIDDEN-ADS} <span class="badge">{HIDDENADS}</span></a>
                                        </li>
                        ...
                        <table id="js-table-list" class="manage-table responsive-table">
                            ...
                            <tr class="ajax-item-listing" data-item-id="{ITEM.id}">
                                ...
                                <td class="item-status" width="12%">
                                    IF("{ITEM.status}"=="active"){ <span
                                        class="label label-success">{ITEM.status}</span>{:IF}
                                    IF("{ITEM.status}"=="pending"){ <span
                                        class="label label-warning">{ITEM.status}</span> {:IF}
                                </td>
                                <td class="action" width="12%"><a href="{LINK_EDIT-AD}/{ITEM.id}"><i
                                        class="fa fa-pencil"></i> {LANG_EDIT}</a><a class="delete item-js-delete"
                                                                                    href="#"
                                                                                    data-ajax-action="deleteMyAd"><i
                                        class="fa fa-remove"></i> {LANG_DELETE}</a></td>
                            </tr>
                            {/LOOP: ITEM}
                            </tbody>
                        </table>
        ...
        <!-- row --></div>
    <!-- container --></section>
<!-- Pending-ads-page -->{OVERALL_FOOTER} 