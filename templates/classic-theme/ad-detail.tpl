        ...
        <div class="section banner"><!-- banner-form -->
            <div class="banner-form banner-form-full">
                <form method="get" action="{SITE_URL}listing" name="locationForm" id="ListingForm">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="dropdown category-dropdown"><a data-toggle="dropdown" href="#"><span class="change-text">{LANG_SELECT-CATEGORY}</span><i class="fa fa-navicon"></i></a>
                                {CAT_DROPDOWN}
                            </div>
                        </div>
                        <div class="col-md-3">
        ...
        <div class="section slider">
            <div class="row"><!-- carousel -->
                    ...
                    <div class="description-info">
                        <div class="ads-details">
                            <ul class="nav nav-tabs">
                                <li class="active">
                                    <a href="#tab-details" data-toggle="tab" aria-expanded="false"><h4>{LANG_ADS-DETAILS}</h4></a>
                                </li>
                                <li>
                                    <a href="#tab-reviews" data-toggle="tab" aria-expanded="true"><h4>{LANG_REVIEWS} ({ITEMREVIEW})</h4></a>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab-details">
                                    ...
                                    <div class="description">
                                        <div class="detail-title">
                                            <h2 class="title-left">{LANG_LOCATION}</h2>
                                        </div>
                                        <div>
                                            <style>
                ...
                <div class="col-md-4">
                    <div class="ad-details">
                        <div class="aside">
                            <div class="aside-header">{LANG_CONTACT-ADVERTISER}</div>
                            <div class="aside-body text-center">
                                ...
                                <div class="user-info ">
                                    ...
                                    <h4><a href="{ITEM_AUTHORLINK}"> {ITEM_AUTHORUNAME} </a></h4>
                                ...
                                <div class="contact-advertiser">
                                    IF("{LOGGED_IN}"=="0"){
                                    <a class="modal-trigger btn btn-warning" href="#loginPopUp"><i
                                                class="fa fa-comment-o"></i>Login to Chat</a>
                                    {:IF}
                                    ...
                                    <a href="#" class="btn btn-info" data-toggle="modal" data-target="#emailToSeller"><i class="fa fa-envelope"></i>{LANG_REPLY-MAIL}</a>
                        ...
                        <div class="aside margin-top-20">
                            <div class="aside-body ">
                                <div class="more-info">
                                    ...
                                    <ul>
                                        <li><i class="fa fa-user-plus"></i><a href="{ITEM_AUTHORLINK}">{LANG_MORE-ADS}
                                                <span>{ITEM_AUTHORUNAME}</span></a></li>
