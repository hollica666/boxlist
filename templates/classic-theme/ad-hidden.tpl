    ...
    <div class="container">
        <div class="breadcrumb-section"><!-- breadcrumb -->
            <ol class="breadcrumb">
                ...
                <li class="active">{LANG_HIDDEN-ADS}</li>
                            ...
                            <div class="collapse-box">
                                ...
                                <div id="MyAds" class="panel-collapse collapse in">
                                    <ul class="acc-list">
                                        ...
                                        <li class="active"><a href="{LINK_HIDDENADS}" class="waves-effect"><i
                    ...
                    <div class="my-quickad section">
                        ...
                        <table id="js-table-list" class="manage-table responsive-table">
                            ...
                            <td class="item-status" width="12%">
                                IF("{ITEM.status}"=="hide"){ <span
                                    class="label label-info">{ITEM.status}</span>{:IF}
                            ...
                            <td class="action" width="12%">
                                ...
                                IF("{ITEM.status}"=="hide"){ <i class="fa  fa-eye"></i> {LANG_SHOW}{:IF}</a>
