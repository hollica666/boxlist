        ...
        <div class="container">
            <div class="breadcrumb-section"><!-- breadcrumb -->
                <ol class="breadcrumb">
                    ...
                    <li>{MAINCATEGORY}{SUBCATEGORY}IF("{MAINCATEGORY}{SUBCATEGORY}"==""){ {LANG_ALL-CATEGORIES} {:IF}</li>
            ...
            <div class="category-info">
                ...
                <div class="row recommended-ads">
                    <div class="col-sm-3 col-md-3">
                        ...
                        {:IF}
                        <div class="tg-sidebartitle"><h2>{LANG_ADVANCE-SEARCH}:</h2></div>
                        <div id="custom-field-block" class="section custom-hidden">
