...
<section id="main" class="clearfix home-two">
    ...
    <div class="container">
                        ...
                        <form action="#">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 banner-icon"><i class="fa fa-map-marker"></i>
                                    <input type="text" class="form-control" id="address-autocomplete" name="location"
                                           placeholder="{LANG_WHERE} ?" style=" border-left: 1px solid #e0e0e0;">
                                    <input type="hidden" id="locality" name="locality" disabled="true" value=""/>
                                    <input type="hidden" id="administrative_area_level_2" name="city" placeholder="city"
                                           value="">
                                    <input type="hidden" id="administrative_area_level_1" name="state"
                                           placeholder="state" value="">
                                    <input type="hidden" id="country-input" name="country" placeholder="country"
                                           value="">
                                </div>
                                <div class="col-md-2">
        ...
        <style>
            .recommended-ads{ display: none !important;}
        </style>
        {:IF}
        <!-- featured-slide -->
