                        ...
                        <div class="collapse-box">
                            ...
                            <div id="account" class="panel-collapse collapse in">
                                <ul class="acc-list">
                                    ...
                                    <li class="active"><a href="{LINK_ACCOUNT_SETTING}" class="waves-effect"><i
            ...
            <div class="col-sm-9 page-content">
                <div class="panel-user-details"><!-- profile-details -->
                    <div class="user-details section">
                        <div class="user-img"><img src="{SITE_URL}storage/profile/small_{AUTHORIMG}" alt="{USERNAME}"
                        ...
                        <form class="row" method="post">
                            <div class="section-body">
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">{LANG_EMAIL}<span
                                            class="required">*</span></label>

                                    <div class="col-sm-9">
                                        <input class="form-control border-form" type="text" name="email" id="email"
                                               value="{EMAIL_FIELD}" onBlur="checkAvailabilityEmail()">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control border-form" type="text" name="username"
                                               id="username" value="{USERNAME_FIELD}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control border-form" type="text" name="password"
                                               id="password" onkeyup="checkAvailabilityPassword()" autocomplete="off">
                                        <span id="password-availability-status">IF("{PASSWORD_ERROR}"!=""){ {PASSWORD_ERROR} {:IF}</span>
                                    </div>
                                </div>
                                <section class="hidden">
                                    <div class="section-title">
                                        <h2>{LANG_PREFERENCES-SETTING}</h2>
                                    </div>
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="logged">
                                            {LANG_COMMENTS-ENABLED} </label>
                                        <label>
                                            <input type="checkbox" name="receive">
                                            {LANG_RECEIVE-NEWSLETTER}.</label>
                                    </div>
                                    <!--end row--></section>
                                <div class="form-group">
