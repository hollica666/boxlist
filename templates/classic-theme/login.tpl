                ...
                <div class="user-account">
                    ...
                    <form method="post">
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="{LANG_USERNAME} / {LANG_EMAIL}"
                                   name="username">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="user-option">
                        <div class="checkbox pull-left">
                            <label for="logged">
                                ...
                                {LANG_KEEP-ME-LOGIN} </label>
                        </div>
                        <div class="pull-right forgot-password"><a href="{LINK_LOGIN}?fstart=1">{LANG_FORGOTPASS}?</a>
                        </div>
                    </div>
                    <!-- forgot-password --></div>
                <a href="{LINK_SIGNUP}" class="btn-primary">{LANG_CREATE-NEW-ACCOUNT}</a></div>
            <!-- user-login --></div>
        <!-- row --></div>
    <!-- container --></section>
<!-- signin-page -->{OVERALL_FOOTER}