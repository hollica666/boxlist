...
<div class="site-action">
    <button data-url="panel/loc_country_add.php" data-toggle="slidePanel" id="slidepanel-show" style="display: none;"> </button>
    ...
    <div class="site-action-buttons">
        <button type="button" data-ajax-response="deletemarked" data-ajax-action="deleteCountry"
