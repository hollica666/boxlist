                        ...
                        <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <select name="paypal_sandbox_mode"  class="form-control">
                                            <option value="Yes" <?php if(get_option($config,'paypal_sandbox_mode') == 'Yes') echo "selected"; ?>>Yes</option>
                                            <option value="No" <?php if(get_option($config,'paypal_sandbox_mode') == 'No') echo "selected"; ?>>No</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input name="paypal_api_username" type="text" class="form-control" placeholder="Enter your Paypal API Username" value="<?php echo get_option($config,'paypal_api_username')?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">Paypal API Password:</label>
                                    <div class="col-sm-6">
                                        <input name="paypal_api_password" type="text" class="form-control" placeholder="Enter your Paypal API Password" value="<?php echo get_option($config,'paypal_api_password')?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">Paypal API Secret:</label>
                                    <div class="col-sm-6">
                                        <input name="paypal_api_signature" type="text" class="form-control" placeholder="Enter your Paypal API Secret" value="<?php echo get_option($config,'paypal_api_signature')?>">
                                    </div>
                                </div>
                            <?php
                            }
                            ...
                            if($folder == "stripe"){
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input name="stripe_secret_key" type="text" class="form-control" placeholder="Enter your Stripe Secret Key" value="<?php echo get_option($config,'stripe_secret_key')?>">
                                    </div>
                                </div>
                            <?php
                            }
