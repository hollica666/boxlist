...
if(!isset($_GET['code']))
{
    ...
    if($code_count == 1){
        $country = $pieces[0];
        $in_name = get_countryName_by_id($config,$country);
    }
    elseif($code_count == 2){
        $country = $pieces[0];
        $subadmin1 = $pieces[1];
        $statecode =  $country.".".$subadmin1;
        $in_name = get_stateName_by_id($config,$_GET['code']). ", ". get_countryName_by_id($config,$country);
    }
    elseif($code_count == 3){
        $country = $pieces[0];
        $subadmin1 = $pieces[1];
        ...
        $statecode =  $country.".".$subadmin1;
        $in_name = get_district_by_code($config,$_GET['code']).", ".get_stateName_by_id($config,$statecode). ", ".  get_countryName_by_id($config,$country);
    }
}
?>
                    ...
                    <form name="form2"  class="form form-horizontal" method="post" data-ajax-action="addCity" id="sidePanel_form">
                        <div class="form-body">
                            ...
                            <?php
                                ...
                                ?>
                                <input type="hidden" name="subadmin1_code" value="<?php echo $subadmin1; ?>" class="form-control">
                            <?php
                            }
                            ?>
                            ...
                            <?php
                                ...
                                ?>
                                <input type="hidden" name="subadmin2_code" value="<?php echo $subadmin2; ?>" class="form-control">
                            <?php
                            }
                            ?>
