...
$q = "SELECT * FROM `".$config['db']['pre']."pages` WHERE `id` = '".$_GET['id']."'";
                    ...
                    <form name="form2"  class="form form-horizontal" method="post" data-ajax-action="editStaticPage" id="sidePanel_form">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <label>Slug:</label>
                                    <input name="slug" type="text" class="form-control" placeholder="Enter Page ID" value="<?php echo $fetch['slug']?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <label>Name:</label>
                                    <input name="name" type="text" class="form-control"  placeholder="Enter Page Title" value="<?php echo $fetch['name']?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <label>Title:</label>
                                    <input name="title" type="text" class="form-control"  placeholder="Enter Page Title" value="<?php echo $fetch['title']?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <label class="css-input switch switch-sm switch-success">
                                        <strong>Active</strong> <input  name="active" type="checkbox" value="1" <?php if($fetch['active'] == '1') echo "checked"; ?> /><span></span>
                                    </label>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <label>Content:</label>
                                    <textarea name="content" rows="6" id="pageContent" class="form-control" placeholder="Enter Page Content"><?php echo $fetch['content']?></textarea>
                                </div>
                            </div>
