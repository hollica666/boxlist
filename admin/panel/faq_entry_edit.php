                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <label class="css-input switch switch-sm switch-success">
                                        <strong>Active</strong> <input  name="active" type="checkbox" value="1" <?php if($quick_fetch['active'] == '1') echo "checked"; ?> /><span></span>
                                    </label>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
                                    ...
                                    <textarea name="content" id="pageContent" rows="14" type="text" class="form-control"><?php echo $quick_fetch['faq_content']?></textarea>
                                </div>
                            </div>
