...
if(isset($_POST['update']))
{
    ...
    <?php
        ...
        update_option($config,"xml_latest",$xml_latest);
        update_option($config,"xml_featured",$xml_featured);
                        ...
                        <div class="white-box">
                            <form class="form form-horizontal" action="xml_manage.php" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <label class="css-input switch switch-sm switch-success">
                                            <input  name="xml_latest" type="checkbox" value="1" <?php if(get_option( $config, "xml_latest") == '1'){ echo "checked"; } ?>/><span></span>
                                        </label>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <label class="css-input switch switch-sm switch-success">
                                            <input  name="xml_featured" type="checkbox" value="1" <?php if(get_option( $config, "xml_featured") == '1'){ echo "checked"; } ?> /><span></span>
                                        </label>
                                    </div>
                                </div>
