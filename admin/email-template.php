        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="pull-right">
                    <a class="btn btn-sm btn-warning" href="<?php echo SITEURL ?>/setting.php#quickad_email">Email Configuration Setting</a>
                </div>
            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <select name="email_template" id="email_template" class="form-control">
                                                            <option <?php if(get_option( $config, "email_template") == '0'){ echo "selected"; } ?> value="0">HTML</option>
                                                            <option <?php if(get_option( $config, "email_template") == '1'){ echo "selected"; } ?> value="1">Text</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="quickad-margin-top-xlg">
                                                            <div class="panel-group">
                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label>Subject</label>
                                                                                        <input name="email_sub_signup_details" placeholder="Email Subject" class="form-control" type="text" value="<?php echo get_option( $config, "email_sub_signup_details") ?>">
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-0" <?php if($config['email_template'] != '0'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <textarea name="email_message_editor_signup_details" rows="6" class="form-control" id="pageContent0" placeholder="Enter Message"><?php echo get_option( $config, "email_message_signup_details") ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-1" <?php if($config['email_template'] != '1'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_textarea_signup_details" rows="10" class="form-control" placeholder="Enter Message"><?php echo get_option( $config, "email_message_signup_details") ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                ...
                                                                <!--1.Create Account Details Email-->
                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label>Subject</label>
                                                                                        <input name="email_sub_signup_confirm" placeholder="Email Subject" class="form-control" type="text" value="<?php echo get_option( $config, "email_sub_signup_confirm") ?>">
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-0" <?php if($config['email_template'] != '0'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_editor_signup_confirm" rows="6" class="form-control" id="pageContent1" placeholder="Enter Message"><?php echo get_option( $config, "email_message_signup_confirm") ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-1" <?php if($config['email_template'] != '1'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_textarea_signup_confirm" rows="10" class="form-control" placeholder="Enter Message"><?php echo get_option( $config, "email_message_signup_confirm") ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label>Subject</label>
                                                                                        <input name="email_sub_forgot_pass" placeholder="Email Subject" class="form-control" type="text" value="<?php echo get_option( $config, "email_sub_forgot_pass") ?>">
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-0" <?php if($config['email_template'] != '0'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_editor_forgot_pass" rows="6" class="form-control" id="pageContent2" placeholder="Enter Message"><?php echo get_option( $config, "email_message_forgot_pass") ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-1" <?php if($config['email_template'] != '1'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_textarea_forgot_pass" rows="10" class="form-control" placeholder="Enter Message"><?php echo get_option( $config, "email_message_forgot_pass") ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label>Subject</label>
                                                                                        <input name="email_sub_contact" placeholder="Email Subject" class="form-control" type="text" value="<?php echo get_option( $config, "email_sub_contact") ?>">
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-0" <?php if($config['email_template'] != '0'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_editor_contact" rows="6" class="form-control" id="pageContent3" placeholder="Enter Message"><?php echo get_option( $config, "email_message_contact") ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-1" <?php if($config['email_template'] != '1'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_textarea_contact" rows="10" class="form-control" placeholder="Enter Message"><?php echo get_option( $config, "email_message_contact") ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label>Subject</label>
                                                                                        <input name="email_sub_feedback" placeholder="Email Subject" class="form-control" type="text" value="<?php echo get_option( $config, "email_sub_feedback") ?>">
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-0" <?php if($config['email_template'] != '0'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_editor_feedback" rows="6" class="form-control" id="pageContent4" placeholder="Enter Message"><?php echo get_option( $config, "email_message_feedback") ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-1" <?php if($config['email_template'] != '1'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_textarea_feedback" rows="10" class="form-control" placeholder="Enter Message"><?php echo get_option( $config, "email_message_feedback") ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label>Subject</label>
                                                                                        <input name="email_sub_report" placeholder="Email Subject" class="form-control" type="text" value="<?php echo get_option( $config, "email_sub_report") ?>">
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-0" <?php if($config['email_template'] != '0'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_editor_report" rows="6" class="form-control" id="pageContent5" placeholder="Enter Message"><?php echo get_option( $config, "email_message_report") ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-1" <?php if($config['email_template'] != '1'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_textarea_report" rows="10" class="form-control" placeholder="Enter Message"><?php echo get_option( $config, "email_message_report") ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label>Subject</label>
                                                                                        <input name="email_sub_ad_approve" placeholder="Email Subject" class="form-control" type="text" value="<?php echo get_option( $config, "email_sub_ad_approve") ?>">
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-0" <?php if($config['email_template'] != '0'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_editor_ad_approve" rows="6" class="form-control" id="pageContent6" placeholder="Enter Message"><?php echo get_option( $config, "email_message_ad_approve") ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-1" <?php if($config['email_template'] != '1'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_textarea_ad_approve" rows="10" class="form-control" placeholder="Enter Message"><?php echo get_option( $config, "email_message_ad_approve") ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label>Subject</label>
                                                                                        <input name="email_sub_re_ad_approve" placeholder="Email Subject" class="form-control" type="text" value="<?php echo get_option( $config, "email_sub_re_ad_approve") ?>">
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-0" <?php if($config['email_template'] != '0'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_editor_re_ad_approve" rows="6" class="form-control" id="pageContent7" placeholder="Enter Message"><?php echo get_option( $config, "email_message_re_ad_approve") ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-1" <?php if($config['email_template'] != '1'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_textarea_re_ad_approve" rows="10" class="form-control" placeholder="Enter Message"><?php echo get_option( $config, "email_message_re_ad_approve") ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label>Subject</label>
                                                                                        <input name="email_sub_contact_seller" placeholder="Email Subject" class="form-control" type="text" value="<?php echo get_option( $config, "email_sub_contact_seller") ?>">
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-0" <?php if($config['email_template'] != '0'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_editor_contact_seller" rows="6" class="form-control" id="pageContent8" placeholder="Enter Message"><?php echo get_option( $config, "email_message_contact_seller") ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-1" <?php if($config['email_template'] != '1'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_textarea_contact_seller" rows="10" class="form-control" placeholder="Enter Message"><?php echo get_option( $config, "email_message_contact_seller") ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                    ...
                    <div id="quickad-tbs">
                        <div class="btn-group quickad-margin-bottom-lg quickad-services-holder">
                            <button class="btn btn-default btn-block dropdown-toggle quickad-flexbox" data-toggle="dropdown">
                                <div class="quickad-flex-cell text-left" style="width: 100%">Notification templates (9)</div>
...
<script src="js/custom-manage/email-template-editor.js"></script>
