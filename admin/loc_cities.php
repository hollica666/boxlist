        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="pull-right">
                    <p class="text-muted">
                        <a href="loc_region.php?code=<?php echo get_countryID_by_state_id($config,$_GET['code']); ?>" class="btn btn-info waves-effect waves-light m-r-10"><i class="fa fa-mail-reply"></i> Back</a>
