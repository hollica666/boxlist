                ...
                if(isset($purchase_data['verify-purchase']['buyer']) )
                {
                    if($purchase_data['verify-purchase']['item_id'] == '18047319'){
                        ...
                        if ($output['success']) {
                            ...
                            $success = true;
                            update_option($config,"wchat_secret_file",$fileName);
                    ...
                    <div class="form-body">
                            ...
                            <div class="form-group bt-switch">
                                ...
                                <div class="col-sm-6">
                                    <label class="css-input switch switch-success">
                                        <input  name="zechat_on_off" type="checkbox" <?php if (get_option($config, "zechat_on_off") == 'on') { echo "checked"; } ?> /><span></span>
                                    </label>
                        ...
                        if(isset($config['wchat_purchase_code']) && $config['wchat_purchase_code'] != ""){
                            ...
                            <div class="form-group bt-switch">
                                ...
                                <div class="col-sm-6">
                                    <label class="css-input switch switch-success">
                                        <input  name="wchat_on_off" type="checkbox" <?php if (get_option($config, "wchat_on_off") == 'on') { echo "checked"; } ?> /><span></span>
                                    </label>
