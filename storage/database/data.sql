...
(1, 1, 'Cars & Bikes', 'cars-bikes', 'pe-7s-car', NULL),
(2, 2, 'Mobiles & Tablets', 'mobiles-tablets', 'pe-7s-phone', NULL),
(3, 3, 'Electronics & Appliances', 'electronics-appliances', 'pe-7s-monitor', NULL),
(4, 4, 'Real Estate', 'real-estate', 'pe-7s-home', NULL),
(5, 5, 'Home & Lifestyle', 'home-&-lifestyle', 'pe-7s-drawer', NULL),
(6, 6, 'Jobs', 'jobs', 'pe-7s-portfolio', NULL),
(7, 7, 'Services', 'services', 'pe-7s-tools', NULL),
(8, 8, 'Entertainment', 'entertainment', 'pe-7s-film', NULL);
...
(3, 'es', 'ltr', 'Spanish', 'spanish', 0, 0),
(6, 'ar', 'rtl', 'Arabic', 'arabic', 0, 0),
(7, 'it', 'ltr', 'Italian', 'italian', 0, 0),
...
(23, 'contact_address', 'Your site address '),
...
(29, 'copyright_text', '2018 <a href="https://www.bylancer.com">Bylancer</a>, {LANG_ALL_RIGHT_RESERVED}'),
...
(77, 'sendgrid_user', ''),
(78, 'sendgrid_pass', ''),
(79, 'email_sub_signup_details', '{SITE_TITLE} - {LANG_THANKSIGNUP}'),
(80, 'email_sub_signup_confirm', '{SITE_TITLE} - {LANG_EMAILCONFIRM}'),
(81, 'email_sub_forgot_pass', '{SITE_TITLE} - {LANG_FORGOTPASS}'),
(82, 'email_sub_contact', '{LANG_CONTACT_SUBJECT_START} - {CONTACT_SUBJECT}'),
(83, 'email_sub_feedback', '{FEEDBACK_SUBJECT}'),
(84, 'email_sub_report', '{LANG_REPORTVIO}  - {SITE_TITLE}'),
(85, 'email_sub_ad_approve', 'Congratulations! {SELLER_NAME} Your ad has been approved'),
(86, 'email_sub_re_ad_approve', 'Congratulations! {SELLER_NAME} Your ad resubmission has been approved'),
(87, 'email_sub_contact_seller', '{SITE_TITLE} - {NAME} {LANG_WANT-TO-CONTACT}'),
(88, 'email_message_signup_details', 'Dear Valued Thanks for creating an account {SITE_TITLE} ,\n\nYour username: {USERNAME}\nYour password: {PASSWORD}\n\n\nHave further questions? You can start chat with live support team.\nSincerely,\n\n{SITE_TITLE} Team!\n{SITE_URL}'),
(89, 'email_message_signup_confirm', 'Greetings from {SITE_TITLE} Team!\n\nThanks for registering with {SITE_TITLE}. We are thrilled to have you as a registered member and hope that you find our service beneficial.\n\nBefore we get you started please activate your account by clicking on the link below\n{CONFIRMATION_LINK}\n\n\nAfter your Account activation you will have  Post Ad, Chat with sellers and more. Once you have your Profile filled in you are ready to go.\n\nHave further questions? You can find answers in our FAQ Section at {LINK_CONTACT}\nSincerely,\n\n{SITE_TITLE} Team!\n{SITE_URL}'),
(90, 'email_message_forgot_pass', '{LANG_TORESET}\n\n{FORGET_PASSWORD_LINK}\n\nHave further questions? You can find answers in our FAQ Section at {LINK_CONTACT}\nSincerely,\n\n{SITE_TITLE} Team!\n{SITE_URL}'),
(91, 'email_message_contact', '{NAME} {LANG_WANT-TO-CONTACT} {SITE_TITLE}:\n\n{LANG_NAME}          : {NAME}\n{LANG_EMAIL}         : {EMAIL}\n\n{LANG_MESSAGE}:\n\n{MESSAGE}\n\n------------------------------------------\n\nThis message has been sent automatically by the {SITE_TITLE} system.\nIf you need to contact us, go to {LINK_CONTACT}'),
(92, 'email_message_feedback', '{NAME} {LANG_SEND-FEEDBACK} {SITE_TITLE}:\n\n{LANG_NAME}          : {NAME}\n{LANG_EMAIL}         : {EMAIL}\n{LANG_PHONE}         : {PHONE}\n\n{LANG_MESSAGE}:\n\n{MESSAGE}\n\n------------------------------------------\n\nThis message has been sent automatically by the {SITE_TITLE} system.\nIf you need to contact us, go to {LINK_CONTACT}'),
(93, 'email_message_report', '{LANG_FOLLOWING-SENT-AUTO}  {SITE_TITLE}:\n\n{LANG_NAME}: {NAME}\n{LANG_USERNAME}: {USERNAME}\n{LANG_EMAIL}: {EMAIL}\n\n{LANG_VIOLATION}: {VIOLATION}\n{LANG_VIOLAT0R}: {USERNAME2}\n{LANG_VIOLATION} URL: {URL}\n\n{DETAILS}'),
(94, 'email_message_ad_approve', 'Congratulations! Your ad to {ADTITLE} on {SITE_TITLE} has been approved. You can view your item here:\n\n{ADLINK}\n\nThanks for your submission!\n\nRegards,\n{SITE_TITLE} Team\n\nQuestions? See our Knowledgebase and Support Center at {LINK_CONTACT}\n\n------------------------------------------\n\nThis message has been sent automatically by the {SITE_TITLE} system.\nIf you need to contact us, go to {LINK_CONTACT}'),
(95, 'email_message_re_ad_approve', 'Congratulations! Your ad Re-Submission to {ADTITLE} on {SITE_TITLE} has been approved. You can view your item here:\n\n{ADLINK}\n\nThanks for your submission!\n\nRegards,\n{SITE_TITLE} Team\n\nQuestions? See our Knowledgebase and Support Center at {SITE_URL}contact.php\n\n------------------------------------------\n\nThis message has been sent automatically by the {SITE_TITLE} system.\nIf you need to contact us, go to {LINK_CONTACT}'),
(96, 'email_message_contact_seller', '{SENDER_NAME} {LANG_WANT-TO-CONTACT}.\n\n{LANG_YOUR-AD}  : {ADTITLE}\n\n{LANG_NAME}     : {SENDER_NAME}\n{LANG_EMAIL}    : {SENDER_EMAIL}\n{LANG_PHONE}    : {SENDER_PHONE}\n{LANG_MESSAGE}  : {MESSAGE}\n\n------------------------------------------\n\nThis message has been sent automatically by the {SITE_TITLE} system.\nIf you need to contact us, go to {LINK_CONTACT}');
...
INSERT INTO `<<prefix>>payments` (`payment_id`, `payment_install`, `payment_title`, `payment_folder`) VALUES
(1, '1', 'Paypal', 'paypal'),
(2, '1', 'Credit & Debit Card', 'stripe'),
(3, '0', 'Wire Transfer', 'wire_transfer'),
(4, '0', 'Cheque 2', 'cheque'),
(5, '0', 'Skrill(MoneyBookers)', 'moneybookers'),
(6, '0', 'NoChex', 'nochex'),
(7, '0', 'Paytm', 'paytm'),
(8, '0', 'Paystack', 'paystack');
